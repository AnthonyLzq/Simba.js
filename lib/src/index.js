...
module.exports = async ({
  ...
  const expressProdPackages = `express morgan swagger-ui-express cors express-pino-logger ${
  ...
  const prodPackages = `${manager} http-errors mongoose @sinclair/typebox pino-pretty ${
    graphql
