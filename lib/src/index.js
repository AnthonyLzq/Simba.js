...
module.exports = async ({
  ...
  const fastifyProdPackages = `fastify @fastify/swagger @fastify/swagger-ui @fastify/cors ${
    graphql ? 'apollo-server-fastify apollo-server-plugin-base' : ''
  }`
  let prodPackages = `${manager} debug @sinclair/typebox http-errors @prisma/client ${
    graphql
