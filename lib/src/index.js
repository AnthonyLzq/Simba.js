...
module.exports = async ({
  ...
  const expressProdPackages = 'express swagger-ui-express @asteasolutions/zod-to-openapi cors'
  ...
  const honoProdPackages = 'hono @hono/node-server @hono/zod-openapi @hono/swagger-ui'
