...
${projectName}/src/services/utils/messages`
  ...
  await Promise.all([
    writeFile(`${projectName}/src/services/index.ts`, t('index.ts.ejs', entityContext)),
    writeFile(`${projectName}/src/services/BaseHttp.ts`, t('BaseHttp.ts.ejs')),
    writeFile(`${projectName}/src/services/${entityContext.Entity}.ts`, t('entity.ts.ejs', entityContext)),
    writeFile(
