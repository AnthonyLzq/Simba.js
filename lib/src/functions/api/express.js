...
`,
  ...
  let createFoldersCommand = `mkdir ${projectName}/src/@types ${projectName}/src/@types/custom`
...
${projectName}/src/database/migrations ${projectName}/src/scripts`
...
`,
  ...
  let createFoldersCommand = `mkdir ${projectName}/src/network \
${projectName}/src/network/routes ${projectName}/src/network/routes/utils`
  ...
  if (graphQL) {
    ...
    createFoldersCommand += ` ${projectName}/src/graphQL ${projectName}/src/graphQL/models \
