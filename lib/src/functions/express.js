...
`,
        file: `${projectName}/src/custom/global.variables.ts`
      },
      response: {
...
`,
        file: `${projectName}/src/custom/express.response.ts`
      },
      request: {
...
`,
        file: `${projectName}/src/custom/express.request.ts`
      },
      index: {
...
`,
        file: `${projectName}/src/custom/index.ts`
      }
    },
    'dto-interfaces': {
      user: {
